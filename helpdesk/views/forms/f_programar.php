			...
			<div class="col-lg-12">
							...
							<div class="form-body pal">
								...
								<div class="form-group">
									<div class="input-icon right"> 
										...
										<input name="usuario_final" disabled placeholder="Usuario que solicito" value="<?=$servicio->usuario_final?>" class="form-control" />
									</div>
								</div>
								<div class="form-group">
										<div class="input-icon right">
				...
				<div class="col-lg-6">
					<div class="panel panel-grey">
						...
						<div class="panel-body pan">
							<form action="<?php echo base_url();?>index.php?/Mantenimiento/atender" method="POST" class="form-horizontal">
								<div class="form-body pal">
									<div class="form-group">
									...
									<div class="form-group">
										<select required="" name="tecnico" class="form-control">
											<option value="0">PERSONAL DE ATENCION..</option>
											<?
									...
									<div class="form-group">
										<div class="input-icon right">
											...
											<input name="fecha" value="<?=$dia?>" type="date" class="form-control"/></div>
									</div>
									<div class="form-group">
											<div class="input-icon right">
												<i class="fa fa-desktop"></i>
												<input name="hora"value="<?=$hora?>" type="time" value="" class="form-control" /></div>
									</div>
									
										<div class="form-group">
											<textarea required="" rows="5" name="solucion" placeholder="Solucion o posible atencion" class="form-control"><?=$servicio->solucion?></textarea>
										</div>
